...
impl ::core::fmt::Display for Uint8 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        let number = bytes.as_ref().try_into()
...
impl ::core::default::Default for Timestamp {
    fn default() -> Self {
        let v: Vec<u8> = vec![0, 0, 0, 0, 0, 0, 0, 0];
        Timestamp::new_unchecked(v.into())
    }
}
impl Timestamp {
    pub const TOTAL_SIZE: usize = 8;
...
pub struct TimestampBuilder(pub(crate) [Byte; 8]);
impl ::core::fmt::Debug for TimestampBuilder {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:?})", Self::NAME, &self.0[..])
    }
}
impl ::core::default::Default for TimestampBuilder {
    fn default() -> Self {
        TimestampBuilder([
            Byte::default(),
            Byte::default(),
